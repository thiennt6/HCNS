...
$(document).ready(function () {
    ...
    $(".tabstrip-switch>div").on("click", toggleSwitcher);
});
...
function tabStripSelect(ev) {
    ...
    if (targetPane.is("#source-code-pane") && !targetPane.find(".active").length) {
        ...
        var tagHelper = $('#source-code-pane li[data-container="taghelper-cshtml"]');
        if (tagHelper.length) {
            ...
            if (typeof (Storage) !== "undefined") {
                if (sessionStorage.isTagHelper) {
                    $(".tabstrip-switch>div").last().click();
                }
            }
        }
...
function toggleSwitcher(e) {
    var target = $(this);
    if (!target.hasClass("switch-option-selected")) {
        $(".switch-option-selected").removeClass("switch-option-selected");
        $(this).addClass("switch-option-selected");

        var container = $("#source-code-pane");
        var htmlHelper = container.find('li.tabstrip-item').first();
        var tagHelper = container.find('li[data-container="taghelper-cshtml"]');
